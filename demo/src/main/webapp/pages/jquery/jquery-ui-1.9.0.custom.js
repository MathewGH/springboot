...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		clearText: 'Clear', // Display text for clear date link
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		showClearInButtonPanel: false, //ShuXiaolong 2013-03-05 Extend:在按钮区显示 清除 按钮
...
//		this._adjustDate(target); 
        ...
        //target.val(this._formatDate(inst, inst.selectedDay, inst.drawMonth, inst.drawYear)); 
	},
	...
	_attachHandlers: function(inst) {
		...
		inst.dpDiv.find('[data-handler]').map(function () {
			var handler = {
				...
				//ShuXiaolong 2013-03-05 Extend:清除按钮事件
				clear: function () {
				    $(id).val('');
					window['DP_jQuery_' + dpuuid].datepicker._hideDatepicker();
				},
	...
	_generateHTML: function(inst) {
	    ...
	    var showClearInButtonPanel =  this._get(inst, 'showClearInButtonPanel');
		...
		var controls = (!inst.inline 
		    ...
		    /*ShuXiaolong 2013-03-05 Extend:在按钮区显示 清除 按钮  Start */
            ((showClearInButtonPanel) ? ('<button type="button" class="ui-datepicker-clear ui-state-default ui-priority-primary ui-corner-all" data-handler="clear" data-event="click">' +
			this._get(inst, 'clearText') + '</button>') : '')  /*End*/
		    : '');
